...
class Post(models.Model):
    ...
    # Correct field linking to AffiliateLink
    affiliate_link_1 = models.ForeignKey(
        'AffiliateLink',   # use string if AffiliateLink is defined later or in another app
        on_delete=models.SET_NULL,
        blank=True,
        null=True,
        related_name="posts_link_1"
    )
    affiliate_link_2 = models.ForeignKey(
        'AffiliateLink',   # use string if AffiliateLink is defined later or in another app
        on_delete=models.SET_NULL,
        blank=True,
        null=True,
        related_name="posts_link_2"
    )
    affiliate_link_3 = models.ForeignKey(
        'AffiliateLink',   # use string if AffiliateLink is defined later or in another app
        on_delete=models.SET_NULL,
        blank=True,
        null=True,
        related_name="posts_link_3"
    )
    affiliate_link_4 = models.ForeignKey(
        'AffiliateLink',   # use string if AffiliateLink is defined later or in another app
        on_delete=models.SET_NULL,
        blank=True,
        null=True,
        related_name="posts_link_4"
    )
    affiliate_link_5 = models.ForeignKey(
        'AffiliateLink',   # use string if AffiliateLink is defined later or in another app
        on_delete=models.SET_NULL,
        blank=True,
        null=True,
        related_name="posts_link_5"
    )
